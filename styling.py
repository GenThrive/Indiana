...
# PAGE SETTINGS
# ----------------------------------------------------------------------------
app_title = 'Indiana Environmental Education Directory'
page_title = 'Indiana Environmental Education Directory'
sub_title = 'Filter on'
...
# MAP SETTINGS
# ----------------------------------------------------------------------------
map_center_lat = 39.7611666
map_center_lon = -87.7802619
map_zoom = 5.2826
